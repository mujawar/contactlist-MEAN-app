...
app.put('/driverlist/:id',function(req,res){
  var id = req.params.id;
    ...
    db.driverlist.findAndModify({query:{_id:mongojs.ObjectId(id)},
    update:{$set:{name:req.body.name,number:req.body.number,address:req.body.address,linces:req.body.linces}},
